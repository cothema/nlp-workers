...
namespace Nlp20Crawler.Migrations
{
    ...
    [Migration("20200423155914_20200423_1")]
    partial class _20200423_1
    {
            ...
            modelBuilder.Entity("Nlp20Crawler.ORM.Entities.CrawlerWebsite", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_crawler_website");

                    b.HasIndex("Id")
                        .IsUnique()
                        .HasName("ix_crawler_website_id");
            ...
            modelBuilder.Entity("Nlp20Crawler.ORM.Entities.CsWordNounSpecification", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_cs_word_noun_specification");

                    b.HasIndex("Id")
                        .IsUnique()
                        .HasName("ix_cs_word_noun_specification_id");

                    b.HasIndex("PatternWordId")
                        .HasName("ix_cs_word_noun_specification_pattern_word_id");
                    ...
                    b.HasIndex("WordId", "Gender", "DeclensionPl1", "DeclensionPl2", "DeclensionPl3", "DeclensionPl4", "DeclensionPl5", "DeclensionPl6", "DeclensionPl7", "DeclensionSg1", "DeclensionSg2", "DeclensionSg3", "DeclensionSg4", "DeclensionSg5", "DeclensionSg6", "DeclensionSg7", "PatternWordId", "Life")
                        .IsUnique()
                        .HasName("ix_cs_word_noun_specification_word_id_gender_declension_pl1_de");
            ...
            modelBuilder.Entity("Nlp20Crawler.ORM.Entities.CsWordUniSpecification", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_cs_word_uni_specification");

                    b.HasIndex("Id")
                        .IsUnique()
                        .HasName("ix_cs_word_uni_specification_id");

                    b.HasIndex("WordId")
                        .IsUnique()
                        .HasName("ix_cs_word_uni_specification_word_id");
            ...
            modelBuilder.Entity("Nlp20Crawler.ORM.Entities.CsWordNounSpecification", b =>
                {
                    b.HasOne("Nlp20Crawler.ORM.Entities.Word", "PatternWord")
                        ...
                        .HasConstraintName("fk_cs_word_noun_specification_word_pattern_word_id");

                    b.HasOne("Nlp20Crawler.ORM.Entities.Word", "Word")
                        .WithMany("CsWordsNounSpecificationWord")
                        .HasForeignKey("WordId")
                        .HasConstraintName("fk_cs_word_noun_specification_word_word_id")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Nlp20Crawler.ORM.Entities.CsWordUniSpecification", b =>
                {
                    b.HasOne("Nlp20Crawler.ORM.Entities.Word", "Word")
                        .WithMany()
                        .HasForeignKey("WordId")
                        .HasConstraintName("fk_cs_word_uni_specification_word_word_id")
            ...
            modelBuilder.Entity("Nlp20Crawler.ORM.Entities.WordMeaning", b =>
                {
                    ...
                    b.HasOne("Nlp20Crawler.ORM.Entities.Word", "Word")
                        .WithMany("WordMeaning")
                        .HasForeignKey("WordId")
                        .HasConstraintName("fk_word_meaning_word_word_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
